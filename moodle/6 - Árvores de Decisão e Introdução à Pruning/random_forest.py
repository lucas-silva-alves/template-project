...
Original file is located at
    https://colab.research.google.com/drive/1LHil_9lC4IFuFvz9zLix1lKi717GI-u5
"""
...
clf = BaggingClassifier(estimator=tree.DecisionTreeClassifier(), n_estimators=100, random_state=0)
